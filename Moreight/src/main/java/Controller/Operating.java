...
//        return resultTuple;
//    }
//    private boolean create(ArrayList<Field> fieldList,String tableName) {
//        Set<String> existingColumnNames = new HashSet<>();
//        for (Field fieldList1 : fieldList) {
//            String columnName = fieldList1.getName();
//            if (existingColumnNames.contains(columnName)) {
...
//                            return false;
//                        }
//                        if (!TypeFilter.columnExist(TableCache.getTable(fieldList1.getReferenceTable()),
...
//                        Table refTable = TableCache.getTable(field.getReferenceTable());
